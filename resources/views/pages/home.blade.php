...
@section('meta_description', 'When and What gives you a beautiful daily summary of everything you did — what you watched, listened to, where you ran, and where you went.')
        ...
        <div class="row align-items-center gy-5">
            <div class="col-lg-6">
                ...
                <p class="lead mt-3 mb-4">
                    When and What pulls together your activity from Trakt, Strava, and ListenBrainz — plus your own location check-ins — into a single, clean daily rundown.
                </p>
                <div class="d-flex flex-wrap gap-3">
                    <a href="https://whenandwhat.app" target="_blank" rel="noopener" class="btn btn-cta btn-lg">
                        Get Started <i class="bi bi-arrow-up-right ms-1"></i>
                    </a>
            ...
            <div class="col-lg-6">
                <div class="screenshot-placeholder ratio ratio-16x9">
                    <span>Daily summary screenshot — coming soon</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-sm-6 col-lg-4 text-center">
                ...
                <p class="text-muted small">Link Trakt, Strava, and ListenBrainz to automatically import what you watch, run, and listen to.</p>
            </div>
            <div class="col-sm-6 col-lg-4 text-center">
                <div class="step-number">2</div>
                <h5 class="fw-700 mb-2">Check in to places</h5>
                <p class="text-muted small">Tap to check in wherever you are — restaurants, parks, venues, or anywhere else you spend your time.</p>
            </div>
            <div class="col-sm-6 col-lg-4 text-center">
                <div class="step-number">3</div>
                <h5 class="fw-700 mb-2">Review your day</h5>
                <p class="text-muted small">Open any day and see a clear, chronological rundown of everything that happened — activities, places, and more.</p>
            </div>
        </div>
    </div>
</section>
...
<div class="cta-banner">
    <div class="container">
        ...
        <p class="mb-4">Start building your daily record — it takes less than a minute to connect your first service.</p>
        <a href="https://whenandwhat.app" target="_blank" rel="noopener" class="btn btn-cta btn-lg">
