...
<div class="container">
    <div class="legal-content">
        ...
        <h2>1. Eligibility</h2>
        <p>You must be at least <strong>13 years of age</strong> to use When and What. By creating an account or using the service, you represent and warrant that you are 13 or older. If you are between the ages of 13 and 18, you represent that your parent or legal guardian has reviewed and agreed to these Terms on your behalf.</p>
        <p>We do not knowingly allow children under 13 to create accounts. If we learn that an account belongs to a child under 13, we will terminate that account and delete the associated data promptly.</p>
        ...
        <p><strong>Auto-renewal.</strong> Subscriptions renew automatically at the end of each billing period using the payment method on file. You will not receive a separate notice before each renewal. You can cancel at any time from your account settings to prevent the next renewal.</p>
        <p><strong>Cancellation.</strong> If you cancel, you retain full access to the service until the end of your current paid period. We do not issue prorated refunds for unused time.</p>
        <p><strong>Refunds.</strong> If you experience a technical issue that we are unable to resolve within 7 days of your initial subscription, contact us and we will work to make it right, which may include a refund at our discretion. Outside of this window, subscription payments are non-refundable.</p>
        <p><strong>Price changes.</strong> We reserve the right to change subscription pricing. We will give you at least 30 days' advance notice of any price increase, and the new price will take effect at your next renewal after that notice period.</p>
        <p><strong>Payment processing.</strong> Payments are processed by Stripe. By subscribing you agree to <a href="https://stripe.com/legal" target="_blank" rel="noopener">Stripe's terms of service</a>. We do not store your full payment card details.</p>
