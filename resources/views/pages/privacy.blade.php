...
<div class="container">
    <div class="legal-content">
        ...
        <p>When and What ("we", "our", or "us") operates the When and What service, accessible at <a href="https://whenandwhat.app">whenandwhat.app</a>. This page describes what information we collect, how we use it, and your rights regarding your data.</p>
        ...
        <ul>
            ...
            <li>With infrastructure providers (hosting, database) who process data on our behalf under appropriate data processing agreements.</li>
        </ul>

        <h2>6. Security</h2>
        <p>We use industry-standard measures to protect your data, including encrypted connections (HTTPS), secure credential storage, and access controls. No system is completely secure, and we cannot guarantee absolute security.</p>

        <h2>7. Your Rights</h2>
        <p>Depending on your location, you may have rights to access, correct, delete, or export your personal data. To exercise any of these rights, please contact us at the address below.</p>
        ...
        <h2>11. Contact</h2>
        <p>If you have questions about this Privacy Policy or your data, please contact us through <a href="https://whenandwhat.app">whenandwhat.app</a>.</p>
    </div>
</div>
@endsection
